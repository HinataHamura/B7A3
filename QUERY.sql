...
-- Query 3: Bookings with NULL payment_status, replace NULL with 'Action Required'
...
-- Query 4: Booking details with user full_name and match fixture
...
-- Query 5: All users with their booking IDs (fans with no bookings show NULL)
...
-- Query 6: Bookings where total_cost is strictly above the average
...
-- Query 7: Top 2 most expensive matches, skipping the single most expensive
